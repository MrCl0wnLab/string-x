...
Este módulo implementa funcionalidade para extrair endereços de criptomoedas de textos
usando expressões regulares. Suporta Bitcoin, Ethereum, Litecoin, Dogecoin e outras moedas.
...
class AuxRegexCryptocurrency(BaseModule):
    ...
    identificar e extrair endereços válidos de várias criptomoedas de strings de texto.
    ...
    def __init__(self):
        ...
        incluindo os padrões regex para detecção de diferentes tipos de endereços.
        """
        super().__init__()
        ...
        self.meta.update({
            ...
            "description": "Extrai endereços de criptomoedas (Bitcoin, Ethereum, Litecoin, etc.) do texto fornecido",
            "author": "MrCl0wn",
            "type": "extractor"
        })
        ...
        self.options = {
            ...
            "ethereum_only": False,  # Se True, extrai apenas endereços Ethereum
            "include_private_keys": False,  # Se True, inclui chaves privadas
            "example": "./strx -l documents.txt -st \"{STRING}\" -module \"ext:cryptocurrency\" -pm",
        ...
        self.crypto_patterns = {
            ...
            # Private keys (WIF format, 51-52 characters starting with 5, K, or L)
            'private_keys': [
    ...
    def run(self):
        ...
        e extrair endereços válidos de criptomoedas. Os endereços encontrados são 
        ...
        if bitcoin_only:
            ...
            for crypto_type in ['bitcoin', 'ethereum', 'litecoin', 'dogecoin', 
                ...
                results.update(self._extract_by_type(target_value, crypto_type))
    ...
    def _extract_by_type(self, text: str, crypto_type: str) -> set:
        ...
        self.log_debug(f"Extraídos {len(results)} endereços do tipo {crypto_type}")
        return results
    ...
    def _identify_crypto_type(self, address: str) -> str:
        ...
        # Litecoin
        elif re.match(r'^[LM][a-km-zA-HJ-NP-Z1-9]{26,33}$', address, re.IGNORECASE):
            return "LTC"
        elif re.match(r'^ltc[a-z0-9]{39,59}$', address, re.IGNORECASE):
            return "LTC"
        elif re.fullmatch(r'^ltc1[ac-hj-np-z02-9]{39,59}$', address, re.IGNORECASE):
            return "LTC"
